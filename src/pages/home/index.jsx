...
class Home extends Language {
  ...
  render() {
    ...
    const headerLogo = headerType === 'primary' ? '/img/code_white.png' : '/img/code_color.png';
    return (
      <div className="home-page">
        ...
        <section hidden={true} className="users-section">
        ...
        <Footer logo="/img/code_color.png" language={language} />
      </div>
    );
  }
}
